...
const Skills = () => {
  return (
    ...
    >
      ...
      <span data-aos='fade-up' data-aos-delay='400' className="text-base sm:text-lg max-w-3xl text-black font-sans mb-12">
      ...
      <div  data-aos='fade-up-left' data-aos-delay='400' className="w-full max-w-5xl flex flex-col md:flex-row gap-6">
        <div  className="flex flex-col items-center bg-black/10 p-6 rounded-md text-black">
