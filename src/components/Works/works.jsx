         ...
         <div className="worksImgs">
            <div className='workSection' id='reverse'>
               ...
               <div>
                  ...
                  <a href="https://elexy-store.vercel.app/" id='anchor' target="_blank" rel="noopener noreferrer">
            ...
            <div className='workSection'>
               <div>
                  ...
                  <a href="https://bloom-clinic-navy.vercel.app/" id='anchor' target="_blank" rel="noopener noreferrer">
                     <FiExternalLink style={{ display: 'inline', marginRight: '6px', verticalAlign: 'middle' }} />
                     Go to Project
                  </a>
               </div>
            ...
            <div className='workSection' id='reverse'>
               ...
               <div>
                  ...
                  <a href="https://vodimovieweb.vercel.app/" id='anchor' target="_blank" rel="noopener noreferrer">
                     <FiExternalLink style={{ display: 'inline', marginRight: '6px', verticalAlign: 'middle' }} />
                     Go to Project
                  </a>
               </div>
